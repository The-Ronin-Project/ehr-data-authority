...
class KafkaPublisher(
     ...
     * This method takes both the [resource] and [aidboxResource] for different reasons. The [resource] is required because
     * Aidbox (as of 2/29/24) does not maintain precision for Decimals. But, we need the [aidboxResource] to provide some
     * data generated by Aidbox, such as the versionId.
     */
    fun publishResource(
        resource: Resource<*>,
